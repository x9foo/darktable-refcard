...
\newcommand{\LANGCompressHistoryStack}{compresser historique de développement}
...
\newcommand{\LANGPopUpForMouseControlOrDirectValueEnter}{fenêtre pour le contrôle de la souris ou valeur directe et entré}
...
\newcommand{\LANGDecreaseBrushSizeHardnessOpacity}{diminuer la taille/dureté/opacité de la brosse}
\newcommand{\LANGIncreaseBrushSizeHardnessOpacity}{augmenter la taille/dureté/opacité de la brosse}
...
\newcommand{\LANGCopyPartOfHistoryStack}{copier une partie de l'historique de développement}
\newcommand{\LANGPastePartOfHistoryStack}{coller une partie de l'historique de développement}
