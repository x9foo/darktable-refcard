...
%  \raggedcolumns
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{k@{\tableseparator}X}
      ...
      \LANGReturn & \LANGSelectSingleImage \\
      \LANGSpace & \LANGToggleImageSelection \\
  ...
  \begin{center}
    \parbox[t]{4.5cm}{
      \includegraphics[height=20mm]{lighttable_view2}
      \centering \footnotesize \LANGLighttable}
    \parbox[t]{4.5cm}{
      \includegraphics[height=20mm]{darkroom_view2}
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{clcl}
      ...
      \includegraphics[height=1em]{demosaic} & \LANGDemosaic                     & \includegraphics[height=1em]{temperature} & \LANGWhiteBalance \\
      \includegraphics[height=1em]{highlights} & \LANGHighlightReconstruction    & \includegraphics[height=1em]{invert} & \LANGInvert \\
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{clcl}
      \includegraphics[height=1em]{velvia} & \LANGVelvia                         & \includegraphics[height=1em]{colorzones} & \LANGColorZones \\
      \includegraphics[height=1em]{channelmixer} & \LANGChannelMixer             & \includegraphics[height=1em]{template} & \LANGColorBalance \\
      \includegraphics[height=1em]{colorout} & \LANGOutputColorProfile           & \includegraphics[height=1em]{template} & \LANGVibrance \\
      \includegraphics[height=1em]{template} & \LANGColorContrast                & \includegraphics[height=1em]{colorin} & \LANGInputColorProfile \\
      \includegraphics[height=1em]{colorcorrection} & \LANGColorCorrection       & \includegraphics[height=1em]{profile_gamma} & \LANGUnbreakInputProfile \\
