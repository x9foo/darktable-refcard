...
%  \raggedcolumns
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{clcl}
      ...
      \includegraphics[height=1em]{basecurve} & \LANGBaseCurve                   & \includegraphics[height=1em]{levels} & \LANGLevels \\
      \includegraphics[height=1em]{flip} & \LANGOrientation                      & \includegraphics[height=1em]{template} & \LANGLocalContrast \\
      \includegraphics[height=1em]{exposure} & \LANGExposure                     & \includegraphics[height=1em]{template} & \LANGGlobalTonemap \\
      \includegraphics[height=1em]{demosaic} & \LANGDemosaic                     & \includegraphics[height=1em]{tonemap} & \LANGToneMapping \\
      \includegraphics[height=1em]{highlights} & \LANGHighlightReconstruction    & \includegraphics[height=1em]{colorreconstruct} & \LANGColorReconstruction \\
