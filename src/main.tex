...
%  \raggedcolumns
  ...
  \begin{center}
%    \includegraphics[height=5.5em]{lighttable_view}
    \includegraphics[height=5.5em]{lighttable_view2}
    \qquad
%    \includegraphics[height=5.5em]{darkroom_view}
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{cl} 
      ...
      \includegraphics[height=1em]{template} & scale pixels \\
      \includegraphics[height=1em]{template} & rotate pixels \\
      \includegraphics[height=1em]{spots} & spot removal \\
      \includegraphics[height=1em]{template} & denoise (profiled) \\
      \includegraphics[height=1em]{rawdenoise} & raw denoise \\
      \includegraphics[height=1em]{hotpixels} & hot pixels \\
  ...
  \colorbox{keycol}{%
    \begin{tabularx}{\tabwidth}{cl} 
      ...
      \includegraphics[height=1em]{lowpass} & lowpass \\
      \includegraphics[height=1em]{lowlight} & lowlight vision \\
      \includegraphics[height=1em]{bloom} & bloom \\
      \includegraphics[height=1em]{colormapping} & color mapping \\
      \includegraphics[height=1em]{template} & colorize \\
      \includegraphics[height=1em]{graduatednd} & graduated \\
    \end{tabularx}}
...
%%% Local Variables:
%%% TeX-master: "darktable-refcard-a4paper-english-dark"
%%% End:
